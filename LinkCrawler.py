...
""")
	print(RESET)
	print(YELLOW)
	print(f"""{GREEN}QUITE IMPORTANT{RESET}: {YELLOW}I CAN'T EMPHASIZE THIS ENOUGH,AFTER EXTRACTING LINKS USING THIS TOOL,CHECK YOUR CURRENT WORKING DIRECTORY FOR THE INTERNAL AND EXTERNAL URLs FILES: {Path.cwd()}""")
	print(RESET)
	print(YELLOW)
