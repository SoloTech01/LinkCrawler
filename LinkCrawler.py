...
""")
	print(RESET)
	print(YELLOW)
	print(f"""{GREEN}IMPORTANT{RESET}: {YELLOW}AFTER EXTRACTING LINKS USING THIS TOOL,CHECK YOUR CURRENT WORKING DIRECTORY FOR THE INTERNAL AND EXTERNAL URLs FILES:""")
	print(RESET)
	print(YELLOW)
